"""
Django settings for zoho_django project.
...
SECRET_KEY = 'django-insecure-s(rbc&ex(i8#zax7zkr!$v_*sxigmhheb4s_-u=m=&pow58fl2'
...
WSGI_APPLICATION = 'zoho_django.wsgi.application'
